...
cuántas letras \enquote{A} hay en una cadena \lstinline!s!.}
...
las apariciones del caracter \enquote{A}. Volvamos al diseño entonces.
...
\enquote{A} que tiene la cadena \lstinline+s+. Pero si nos detenemos en medio de
...
refleja la cantidad de \enquote{A} que hay en los primeros 10 caracteres de
\lstinline+s+.
...
cantidad de \enquote{A} que contiene la parte izquierda de \lstinline+s+ cuando
...
iguales a \enquote{A} de la cadena vacía es $0$.
...
\ejercicioc{¿Hay más letras \enquote{A} o más letras \enquote{E} en una cadena?
