...
\enquote{Lo último que se apiló es lo primero que se usa}, que es exactamente lo que
...
El TAD \emph{cola} modela el comportamiento: \enquote{el primero que llega
...
de Av. de Mayo al 800 que tenía un cartel que decía \enquote{No se recibirán más de 5 cartas por persona}.
