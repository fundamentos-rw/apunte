...
Este concepto es similar al ya mencionado con respecto a la
\emph{documentación} de funciones; de hecho el contrato suele ser incluido en
la documentación, y su finalidad es asegurar que otros programadores sepan
cuál es la forma correcta de utilizar la función.
