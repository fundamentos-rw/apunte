...
La \emph{interfaz} o \emph{firma} de una función es su nombre, más los
parámetros que recibe, más los valores que devuelve. Para invocar una función
cualquiera, es suficiente con saber cómo es su interfaz, y no es necesario saber
...
cambiando su interfaz, y eso nos obliga a cambiar cualquier lugar del código
que contenga alguna llamada a la función.

En el ejemplo de \lstinline!sumar! implementada con recursividad de cola nos
vimos obligados a modificar la interfaz de la función agregando el parámetro
\lstinline!suma! que no formaba parte del problema inicial. Pudimos hacerlo
elegantemente utilizando un valor por omisión (|suma=0|), pero la interfaz de
todos modos quedó confusa.

Hay casos en los que no podemos salvar un cambio en la interfaz.  Por ejemplo,
...
que va a cumplir con la interfaz deseada:
...
simplificar el código de las funciones recursivas. Por ejemplo, si quisiéramos
hacer validaciones de los parámetros, no
...
la interfaz, validar parámetros, inicializar datos o manejar excepciones.
