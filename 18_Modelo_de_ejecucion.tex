...
$\varphi = \frac{1 + \sqrt5}2$ el \enquote{número de oro} y el operador
...
información \enquote{hacia abajo}. Y en otros casos, si bien no es necesario,
...
Ejemplo: \lstinline|combinaciones(['a', 'b', 'c'], 2)| debe imprimir
\lstinline|aa ab ac ba bb bc ca cb cc|.
\end{ejercicio}
