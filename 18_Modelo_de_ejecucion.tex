...
determine en forma recursiva la suma de los elementos
...
Como ya sabemos diseñar funciones recursivas intuimos que reduciremos el
problema según \lstinline!k! y que tendremos una llamada recursiva para cada
valor del alfabeto. El cuerpo de nuestra función será algo así:
\begin{codigo-python-sn}
...
En primer lugar, según el problema que estamos resolviendo, tenemos que
\emph{imprimir}, no \emph{devolver}. En total tenemos que imprimir
$len(alfabeto)^k$ combinaciones, que no es otra cosa que la cantidad de veces
que se va a ejecutar el caso base.
Entonces tenemos dos opciones, o hacemos que en el
...
es la función \lstinline!_combinaciones! que es la que realiza el trabajo, por
