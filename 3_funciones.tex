...
A medida que los programas se hacen más grandes y complejos suele ser
...
\begin{codigo}{\label{modulo-main} saludos.py}{Módulo principal del programa}
\begin{codigo-python-sn}
(@import saludos@)
...
archivo |saludo.py| y lo ejecutará.
