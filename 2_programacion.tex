...
Linux\footnote{\url{https://github.com/torvalds/linux}} fue publicado por
primera vez en 1991, y aun hoy sigue en desarrollo. El código fuente es
público, y cualquiera puede contribuir aportando mejoras: más de $15 000$
personas participaron en el desarrollo. En total, el código
fuente contiene más de 24 millones de líneas de código.
\end{sabias_que}

Cuanto más grande es un proyecto de software, más difícil es su construcción y
mantenimiento, y más tenemos que prestar atención a la _calidad_ con la que
está construido. Aquí se enumeran algunas de las propiedades que contribuyen a
la calidad, y algunas preguntas que podemos hacer para medir cuánto
contribuye cada factor:
