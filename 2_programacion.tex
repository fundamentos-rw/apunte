...
por el usuario, a cada uno le calcule el factorial (utilizando la función escrita en el el ejercicio
1.4) e imprima el resultado junto con el número de orden correspondiente.
\end{ejercicio}
