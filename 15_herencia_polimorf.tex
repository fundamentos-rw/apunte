...
que se encuentre dentro de la \enquote{familia} de las secuencias. En cambio, si
...
definida como heredera de otra |T| es que debe cumplirse que \enquote{S es un T}.
...
entre clases \enquote{S contiene a T}. Por ejemplo, Vehículo {\bf contiene} un
