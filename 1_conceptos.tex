...
En Python tenemos dos tipos de datos numéricos: los \emph{enteros} y los
\emph{flotantes}. Los números enteros representan el valor entero exacto que
...
teléfono, la plata en una cuenta bancaria\footnote{¿Pero la moneda no tiene
...
ángulo, el valor de una función, el factorial de un número\footnote{¿Pero
