...
Para crear un |set| usamos la sintaxis |{<expresion>, <expresion>, ...}|\footnote{%
...
sintaxis {\texttt \{\}} no funcionará, ya que eso crea un diccionario vacío. Podemos
crear un conjunto vacío con: \verb|set()|}:
