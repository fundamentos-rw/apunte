...
mediante un índice numérico, el acceso será a través de su clave, que en puede
...
es posible iterar pos sus claves y usar esas claves para acceder a los valores:
